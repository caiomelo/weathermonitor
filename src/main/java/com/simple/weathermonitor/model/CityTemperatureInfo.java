...
import com.simple.weathermonitor.model.accuweather.Temperature;
import lombok.Data;
...
public class CityTemperatureInfo {
    ...
    public CityTemperatureInfo(UserObservedCity userObservedCity, CurrentTemperature currentConditions) {
